				...
				<tr bgcolor="#f5f5f5">
					<td width=50% valign=top style="padding: 10px">
						<table border="0" cellpadding="0" cellspacing="0" width=100%>
								...
								<td class="bare" align="left">
									<select id="emp_ptype" name="emp_ptype" style="width : 160px">
										<?php
											...
											while($_xrow1 = $ptype->fetch_array())
											{
							...
							<tr><td height=2></td></tr>
							<tr>
								<td class="bareThin" width="25%" align="left">Monthly Factor (in Days):&nbsp;&nbsp;</td>
								<td class="bare" align="left">
									<input type="text" id="emp_factor" name="emp_factor" style="width : 160px" value="<?php echo $_xres['PAYROLL_FACTOR'] ?>"> <span class="baregray">(For Semi-monthly Employees)</span>
								</td>
							</tr>
							<tr><td height=2></td></tr>
							<tr>
							...
							<tr>
								...
								<td class="bare" align="left">
									...
									<select name="emp_wtax" id="emp_wtax" style="width: 40px;">
										<option value="Y" <?php if($_xres['W_TAX'] == 'Y') { echo "selected"; }?>>Y</option>
										<option value="N" <?php if($_xres['W_TAX'] == 'N') { echo "selected"; }?>>N</option>
									</select>
								</td>
							</tr>
							<tr><td height=2></td></tr>
					...
					<td  style="padding: 10px;" valign="top">	
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							...
							<tr><td height=2></td></tr>
							<tr>
								<td class="bareThin" width="35%" align="left">Pre-determined W-Tax Deduction :&nbsp;&nbsp;</td>
								<td class="bare" align="left">
									<input type="text" id="emp_tax" name="emp_tax" style="width : 100px" value="<?php echo number_format($_xres['EMP_TAX'],2) ?>"> <span class="baregray">(For Taxable Employees Only)</span>
								</td>
							</tr>
							<tr><td height=2></td></tr>
							<tr>
							...
							<tr>
								...
								<td class="bare" align="left">
									...
									<input type="hidden" name="emp_ewt" id="emp_ewt">
								</td>
							</tr>
							<tr><td height=2></td></tr>
							<tr>
